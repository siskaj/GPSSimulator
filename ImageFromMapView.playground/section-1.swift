...
func setCenterOfMapToLocation(location: CLLocationCoordinate2D) -> MKMapView {	var mapView = MKMapView(frame: CGRectMake(0, 0, 300, 300))
	mapView.setRegion(region, animated: true)
	return mapView}

var map1:MKMapView = setCenterOfMapToLocation(location)
